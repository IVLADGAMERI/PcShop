...
data class Gpu (
    ...
    var vendor: com.cmd.PcShop.domain.dao.product.entity.product.pc.component.gpu.GpuVendor,
    @ManyToOne
    @JoinColumn(name = "model_id")
    var model: com.cmd.PcShop.domain.dao.product.entity.product.pc.component.gpu.GpuModel,
